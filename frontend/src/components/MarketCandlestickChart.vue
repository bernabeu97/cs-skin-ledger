...
function render() {
  ...
  chart.setOption({
    ...
    yAxis: {
      ...
      axisLabel: { color: '#8a91a0', formatter: (value: number) => value.toFixed(0) }
    },
    dataZoom: [
      { type: 'inside', start, end: 100 },
      { type: 'slider', start, end: 100, height: 14, bottom: 7, borderColor: 'transparent', fillerColor: 'rgba(52,120,246,.13)' }
    ],
    series: [{
      name: '指数',
      type: 'candlestick',
      itemStyle: {
        color: '#0b9a52', color0: '#d33c4b',
        borderColor: '#0b9a52', borderColor0: '#d33c4b'
      },
